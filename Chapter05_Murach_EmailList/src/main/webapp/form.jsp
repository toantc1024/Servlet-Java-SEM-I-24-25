...
<div class="wrapper">
    ...
    <form method="post" action="emailList">
        ...
        <div style="display:flex; gap:1rem">
            <div>
                <input type="radio" id="se" name="hear_us_option" value="Search engine">
        ...
        ${param.isSend eq "true" ? 'checked' : ''} type="checkbox" id="isSendEmailCheckbox" name="isSend" value="true">
        <label
                for="isSendEmailCheckbox">YES, please send me email announcements.</label><br>
